...
export var ic_add = component(ic_circle.cloneNode(true)).append( //ic_add_circle_outline_black_36px
	svg('path').attr('d',
...
export var ic_clear = component(ic_circle.cloneNode(true)).append( //ic_clear_black_36px
	svg('path').attr('d',
		'M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z'
	)
).node

export var ic_remove = component(ic_circle).append( //ic_remove_circle_outline_black_36px
	svg('path').attr('d',
