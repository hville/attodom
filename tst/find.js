...
ct('find', function() {
	var h01 = el('h2').p('textContent', 'H01'),
			h0 = el('h1').append(['H0', el('h2').p('textContent', 'H00'), h01]),
			h10 = el('h2').p('textContent', 'H10'),
			h1 = el('h1').append('H1', h10, el('h2').p('textContent', 'H11')),
